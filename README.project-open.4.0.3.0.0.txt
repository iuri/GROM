  ...
  - README.project-open.4.0.3.0.0 - this file
  - LICENSE.project-open.4.0.3.0.0 - the license for the included software
  - pg_dump.4.0.3.0.0.sql - a database dump of the current version
  ...
  # mv /tmp/packages.4.0.3.0.0 packages
  ...
  the C:\temp\packages.4.0.3.0.0 folder:

  - Go to Control Panel -> Administrative Tools -> Services
    and stop the "project-open AOLServer" service.
  - Rename C:\project-open\packages into C:\project-open\packages.old
  - Move C:\temp\packages.4.0.3.0.0 to C:\project-open\
  - Rename C:\temp\packages.4.0.3.0.0 to C:\project-open\packages\
