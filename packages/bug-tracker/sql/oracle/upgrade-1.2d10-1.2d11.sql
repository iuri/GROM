-- Folders had wrong context_id and no package_id set.
--
-- @author Lars Pind (lars@collaboraid.biz)
--
-- $Id: upgrade-1.2d10-1.2d11.sql,v 1.1.1.1 2006/10/25 17:55:10 cvs Exp $


-- recreate the bt_project package
...
begin
    for rec in (select project_id, folder_id from bt_projects) loop
