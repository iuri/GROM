-- packages/ref-us-counties/sql/oracle/ref-us-counties-create.sql
--
-- @author jon@jongriffin.com
-- @creation-date 2001-08-27
-- @cvs-id $Id: ref-us-counties-create.sql,v 1.1.1.1 2005/12/03 18:32:23 cvs Exp $
...
begin
    v_id := acs_reference.new(
        ...
        source_url     => 'http://ftp.census.gov/geo/www/gazetteer/places.html',
        last_update    => to_date('1990-12-31','YYYY-MM-DD'),
