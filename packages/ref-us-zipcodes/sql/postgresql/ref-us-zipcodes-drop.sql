...
-- @cvs-id $Id: ref-us-zipcodes-drop.sql,v 1.1.1.1 2005/12/03 18:32:38 cvs Exp $
...
begin
    for rec in select * from acs_reference_repositories where upper(table_name) like ''US_ZIP%'' loop
