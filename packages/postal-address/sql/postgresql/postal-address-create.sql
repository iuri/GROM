...
(
    ...
    -- Deleted the not null constraint as it is sensible to just store the country
    -- So you can do E-Mail based on location, even if you do not know the exact address
